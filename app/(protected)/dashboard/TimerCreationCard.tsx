...
export function TimerCreationCard({
  ...
  const steps = ["date", "name", "notifications"] as const;
  ...
  const animateToStep = (
    newStep: "date" | "name" | "notifications",
  ...
  const handleConfirm = () => {
    ...
    if (step === "date" && combinedDateTime) {
      animateToStep("name", "forward");
    } else if (step === "name" && timerName && combinedDateTime) {
      animateToStep("notifications", "forward");
  ...
  const handleBack = () => {
    if (step === "name") {
      animateToStep("date", "backward");
    } else if (step === "notifications") {
      animateToStep("name", "backward");
    }
  };
  ...
  return (
    <>
      ...
      <Dialog open={modalState} onOpenChange={handleOpenChange}>
        <DialogContent className="w-[95vw] max-[450px] max-h-[95vh] overflow-y-auto p-4 sm:p-6">
          <DialogHeader>
          ...
          <div className="relative flex flex-col items-center space-y-4 min-h-[420px] sm:min-h-0 overflow-hidden">
                  ...
                  <div className="flex justify-between w-full gap-3 mt-4">
                    ...
                    <Button
                      ...
                      disabled={
                        ...
                        selectedTime.hours === "" ||
                        isAnimating
                      } // Added hours validation and animation state
                      className="flex-1"
                    >
              ...
              {step === "name" && (
                <>
                  ...
                  <Input
                    ...
                    className="w-[95%] mx-auto font-mono placeholder:text-zinc-300 focus:shadow-md"
                  />
                  <div className="flex justify-between w-full gap-3 mt-4">
                    <Button
                      variant="outline"
                    ...
                    <Button
                      onClick={handleConfirm}
                      disabled={!timerName || isAnimating}
                      className="flex-1"
                    >
                      <span className="transition-transform duration-200 group-hover:translate-x-1">
                        Next
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 border rounded-lg">
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <Mail className="w-5 h-5 text-blue-500 flex-shrink-0 transition-transform duration-200 hover:scale-110" />
                      ...
                      <div className="flex items-center justify-between p-3 border rounded-lg">
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <PhoneCallIcon className="w-5 h-5 text-[#E2725B] flex-shrink-0 transition-transform duration-200 hover:scale-110" />
                          <div className="min-w-0 flex-1">
                            <Label
                              htmlFor="call-toggle"
                              className="font-medium block"
                      ...
                      <div className="flex items-center justify-between p-3 border rounded-lg">
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <MessageSquare className="w-5 h-5 text-green-500 flex-shrink-0 transition-transform duration-200 hover:scale-110" />
                          <div className="min-w-0 flex-1">
                            <Label
                              htmlFor="sms-toggle"
                              className="font-medium block"
                      ...
                      <div className="flex items-center justify-between p-3 border rounded-lg">
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <RefreshCcwDotIcon className="w-5 h-5 text-purple-500 flex-shrink-0 transition-transform duration-200 hover:scale-110" />
                          <div className="min-w-0 flex-1">
                            <Label
                  ...
                  <div className="flex justify-between w-full gap-3 mt-4">
                    ...
                    >
                      <span className="transition-all duration-200 group-hover:scale-105">
                        <span className="hidden sm:inline">Create Notifoo</span>
